...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      ...
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        menu
        <!-- <div class="container hambarger">
          <div class="row gx-4">
            <div class="navMenu"><span>Menu</span></div> -->
            <div >
              <div class="openbtn6 gx-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 mx-auto text-center py-5">
          <ul class="slider">
            <li><img src="img/IMG_1177.jpg" alt=""></li>
            <li><img src="img/IMG_1648.jpg" alt=""></li>
            <li><img src="img/IMG_1676.jpg" alt=""></li>
            <li><img src="img/IMG_1750.jpg" alt=""></li>
            <li><img src="img/IMG_1990.jpg" alt=""></li>
            <li><img src="img/IMG_2113.jpg" alt=""></li>
            <li><img src="img/IMG_2597.jpg" alt=""></li>
            <li><img src="img/IMG_3046.jpg" alt=""></li>
          </ul>
          <h1>MASIDE</h1>
          <p>
    ...
    <div class="container px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-lg-8">
          ...
          <img class="img-fluid about_img" src="img/3040945_m.jpg" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="container px-4 px-lg-5">
      ...
      <div class="row gx-0 mb-4 mb-lg-5 align-text-center ">
        <div class="col-xl-8 col-lg-7">
          <img class="img-fluid mb-3 mb-lg-0 profile_img" src="img/IMG_3142.jpeg" alt="">
        </div>
        <div class="col-xl-4 col-lg-5 aline-self-center">
          <div class="featured-text text-center">
            <h4>Profile</h4>
            <p class="text-black-50" >
              山梨県在住。現在食品メーカーの品質保証を務める傍ら、Webサイト制作におけるコーディング、レスポンシブ対応を行なっています。<br>
      ...
      <div class="row gx-0 mb-5 mb-lg-0 justify-content-center" id="works">
        <div class="col-lg-6">
          <a href="<?php echo esc_url(home_url('http://portfolio.local/works/'));?>">
            <img class="img-fluid work_one_img w-100 " src="img/SocialTech.png" alt="">
          </a>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
        <div class="col-lg-6">
          <a href="<?php echo esc_url(home_url('http://portfolio.local/works/'));?>">
            <img class="img-fluid work_two_img w-100" src="img/SAMURAI UNIVERSITY.png" alt="">  
          </a>
        </div>
    ...
    <div class="container px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5">
        <div class="col-md-10 col-lg-8 mx-auto text-center">
          <h2 class="text-white mb-5 signup_h2"><a href="<?php echo esc_url(home_url(' http://portfolio.local/contact/'));?>" >Contact</a></h2>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer class="footer bg-black small text-center text-white-50">
    <div class="container px-4 px-lg-5">
      Copyright ©︎ m.ohno Website 2023
    </div>
  </footer>
